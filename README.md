...
<head>
    ...
    <style>
        ...
        * {
        ...
        .hero-visual .hero-placeholder-img img {
            width: 100%;
            height: 100%;
            object-fit: cover;
            display: block;
        ...
        .history-img-card .img-placeholder img {
            width: 100%;
            height: 100%;
            object-fit: cover;
            display: block;
        ...
        .repertoire-card .card-img-wrap img {
            width: 100%;
            height: 100%;
            object-fit: cover;
            display: block;
        ...
        .repertoire-card:hover .card-img-wrap img {
        ...
        <div class="hero-inner">
            ...
            <div class="hero-visual">
                <div class="hero-placeholder-img">
                    <img src="images/秦腔舞台.jpg" alt="秦腔舞台表演">
                </div>
            </div>
        </div>
        ...
        <div class="section-container">
            ...
            <div class="repertoire-grid">
                ...
                <div class="repertoire-card reveal reveal-delay-2">
                    <div class="card-img-wrap">
                        <img src="images/sdx.jpg" alt="三滴血">
                ...
                <div class="repertoire-card reveal reveal-delay-3">
                    <div class="card-img-wrap">
                        <img src="images/huoyanjv.jpg" alt="火焰驹">
                ...
                <div class="repertoire-card reveal reveal-delay-4">
                    <div class="card-img-wrap">
                        <img src="images/zrhf.jpg" alt="周仁回府">
                ...
                <div class="repertoire-card reveal reveal-delay-5">
                    <div class="card-img-wrap">
                        <img src="images/yxh.jpg" alt="游西湖">
                ...
                <div class="repertoire-card reveal reveal-delay-6">
                    <div class="card-img-wrap">
                        <img src="images/zsge.jpg" alt="赵氏孤儿">
            ...
            <div class="artists-row">
                <div class="artist-card reveal reveal-delay-1">
                    <div class="artist-img-wrap">
                        <img src="images/rzz.jpg" alt="任哲中">
                    </div>
                    <h3>任哲中</h3>
                ...
                <div class="artist-card reveal reveal-delay-2">
                    <div class="artist-img-wrap">
                        <img src="images/lyz.webp" alt="刘毓中">
                    </div>
                    <h3>刘毓中</h3>
                ...
                <div class="artist-card reveal reveal-delay-3">
                    <div class="artist-img-wrap">
                        <img src="images/lzm.webp" alt="李正敏">
                    </div>
                    <h3>李正敏</h3>
                ...
                <div class="artist-card reveal reveal-delay-4">
                    <div class="artist-img-wrap">
                        <img src="images/myx.webp" alt="马友仙">
                    </div>
                    <h3>马友仙</h3>
            ...
            <div class="mask-gallery">
                <div class="mask-item reveal reveal-delay-1">
                    <div class="mask-circle">
                        <img src="images/huanglian.jpg" alt="红色脸谱">
                    </div>
                    <h4>红色脸谱</h4>
                ...
                <div class="mask-item reveal reveal-delay-2">
                    <div class="mask-circle">
                        <img src="images/bailian.jpg" alt="白色脸谱">
                    </div>
                    <h4>白色脸谱</h4>
                ...
                <div class="mask-item reveal reveal-delay-3">
                    <div class="mask-circle">
                        <img src="images/heilian.jpg" alt="黑色脸谱">
                    </div>
                    <h4>黑色脸谱</h4>
                ...
                <div class="mask-item reveal reveal-delay-4">
                    <div class="mask-circle">
                        <img src="images/huanglian.jpg" alt="黄色脸谱">
                    </div>
                    <h4>黄色脸谱</h4>
                ...
                <div class="mask-item reveal reveal-delay-5">
                    <div class="mask-circle">
                        <img src="images/lvlian.jpg" alt="绿色脸谱">
                    </div>
                    <h4>绿色脸谱</h4>
                ...
                <div class="mask-item reveal reveal-delay-6">
                    <div class="mask-circle">
                        <img src="images/jinlian.png" alt="金色脸谱">
                    </div>
                    <h4>金色脸谱</h4>
